...
Solo (alias  solo71 - www.wolfpackclan.com)

-------------------------
User Visit Module

This module allows you to monitor your members activities on your site. 

Installation : upload the "html" directory and the related files and directories on your server.

Attention !

The "footer.php" file must replace the orginal one on your server. This file is the Xoops 2.0.4 version one. If you prefer to keep your original one of your site (for previous or newer version reasons) or if you are not sure at all, just add the followin code in your original "footer.php" file.

include(XOOPS_ROOT_PATH."/modules/uservisit/index.php");

The author of this module can be responsible for any problems caused to your Xoops site due to this module installation.
