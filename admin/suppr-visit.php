...
echo "<div style='float:left;'><img src='../"
      . $pathModIcon32
      . "/delet.png'  alt='User Visit'></div><br style='clear:both;'><hr><br>";
...
function SupprM($visitname, $q)
{
    ...
    if ($q == 'yes') {
        ...
        echo "<fieldset><legend>&nbsp;"
              . _AD_USERVISIT_ALLSTATS
              . "&nbsp;"
              . $visitname
              . "&nbsp;"
              . _AD_USERVISIT_DELETED
              . "&nbsp;</legend><div style='text-align:center;'><img src='../assets/images/attention.png'  alt='Attention'></div>";
        echo "<br><br><div style='text-align:center;'><div class='ul_button'><a href='admin.php'>"
              . _AD_USERVISIT_BACKLIST
              . "</a></div></div><br></fieldset>";
    } else {
        echo "<fieldset><legend>&nbsp;"
              . _AD_USERVISIT_DELSTATS
              . "&nbsp;"
              . $visitname
              . "&nbsp;?</legend>";
        echo "<div style='text-align:center;'><img src='../assets/images/attention.png'  alt='Attention'></div>";
        echo "<br><br><div style='text-align:center;'><div class='ul_button'><a href='suppr-visit.php?su=memb&visitname="
              . $visitname
              . "&q=yes'>"
              . _AD_USERVISIT_YES
              . "</a></div>&nbsp;&nbsp;<div class='ul_button'><a href='admin.php'>"
              . _AD_USERVISIT_NO
              . "</a></div></div><br></fieldset>";
    }
}
...
function SupprD($visitname, $id, $q, $supip)
{
    ...
    if ($q == 'yes') {
        ...
        echo "<fieldset><legend>&nbsp;"
              ...
              . $visitname
              . "&nbsp;?</legend><div style='text-align:center;'><img src='../assets/images/attention.png'  alt='Attention'></div>";
        echo "<br><br><div style='text-align:center;'><div class='ul_button'><a href='suppr-visit.php?su=mdet&visitname="
              . $visitname
              . "&supip="
              . $supip
              . "&q=yes'>"
...
function SupprAll($q)
{
    ...
    if ($q == 'yes') {
        ...
        echo "<fieldset><legend>&nbsp;"
              . _AD_USERVISIT_DELSTATSALL
              . "&nbsp;</legend><div style='text-align:center;'><img src='../assets/images/attention.png'  alt='Attention'></div>";
        echo "<br><br><div style='text-align:center;'><div class='ul_button'><a href='suppr-visit.php?su=mems&q=yes'>"
              . _AD_USERVISIT_YES
              . "</a></div>&nbsp;&nbsp;<div class='ul_button'><a href='admin.php'>"
              . _AD_USERVISIT_NO
              . "</a></div></div><br></fieldset>";
